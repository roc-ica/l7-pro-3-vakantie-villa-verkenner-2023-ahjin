...
<head>
    ...
    <link rel="stylesheet" href="/frontend/protected/styles/header.css">
            ...
            <li>
                <a href="/frontend/protected/logout.php">
                    <svg viewBox="0 0 24 24" width="20" height="20">
                        ...
                        <path d="M12,10c-1.1,0-2,0.9-2,2s0.9,2,2,2s2-0.9,2-2S13.1,10,12,10z M7,12c0,2.76,2.24,5,5,5s5-2.24,5-5h2c0,3.87-3.13,7-7,7s-7-3.13-7-7H7z" fill="#fff"/>
                    </svg>
                    <h2>Uitloggen</h2>
                </a>
            </li>
